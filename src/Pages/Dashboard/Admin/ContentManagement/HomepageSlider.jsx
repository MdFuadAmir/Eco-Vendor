...
const HomepageSlider = () => {
  ...
  const handleEdit = (slider) => {
    ...
    setValue("subtitle", slider.subtitle);
    setValue("image", slider.image);
    setValue("buttonText", slider.buttonText);
  ...
  return (
    <div className="p-6">
      ...
      {/* Table */}
      <div className="overflow-x-auto bg-white dark:bg-darkfooter/90 rounded-xl shadow">
          ...
          <div className="bg-white dark:bg-darknav p-6 rounded-xl w-full max-w-md">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-gray-200 dark:bg-darkbody dark:placeholder:text-gray-400 dark:text-gray-200 rounded"
              />
              <label className="dark:text-gray-300">button link</label>
              <input
                {...register("link")}
